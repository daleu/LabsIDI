...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(applyzoom(int)));
        QObject::connect(widget, SIGNAL(enviarFOV(int)), verticalSlider, SLOT(setValue(int)));
